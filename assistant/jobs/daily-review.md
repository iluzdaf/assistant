...
- Job run-log files from the reviewed period, following `docs/job-run-log.md`.
...
- Read the job run-log files for the review window before using automation memory or ad hoc notes.
...
- Job run-log files for the review window were checked, or the missing log evidence is stated.
