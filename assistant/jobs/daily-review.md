...
- Review the period since the last successful daily review section.
- If no prior daily review section exists, review the previous local day.
...
- One Bear note titled `Assistant Daily Review`.
